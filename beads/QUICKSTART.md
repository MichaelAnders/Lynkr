...
This is reference documentation from the beads project.
Source: https://github.com/steveyegge/beads/blob/main/docs/QUICKSTART.md
AI agents: See AGENTS.md for protected files list.
-->
